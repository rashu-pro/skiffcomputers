...
?>
<?php (is_archive())?$product_class='product-wrapper-archive':$product_class=''; ?>
<div class="product-wrapper <?php echo $product_class ?>">
    ...
    <div class="product-element-bottom">
        ...
        echo (is_archive()) ? "<div class='short-info'>".do_shortcode(get_the_excerpt())."</div>":'';
        ?>
